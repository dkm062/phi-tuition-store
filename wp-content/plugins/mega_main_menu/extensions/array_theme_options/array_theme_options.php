...
//								__( 'FontAwesome (400)', 'mega_main_menu' ) => 'fontawesome',
						...
						array(
							...
							'descr' => __( 'This is real value of "max_input_vars" option in the configuration of your server. You can try to increase it in one of the ways that are described in', 'mega_main_menu' ) . '<a href="http://manual.menu.megamain.com/#max_input_vars" target="_blank">' . __( 'Documentation', 'mega_main_menu' ) .'</a>.',
				...
				array(
					...
					'options' => array(
						array(
							...
							'key' => 'support',
							'type' => 'just_html',
							'default' => '<br /><br /> <a href="http://manual.menu.megamain.com/" target="_blank">' . __( 'Online documentation', 'mega_main_menu' ) . '</a>. <br /><br /> ' . __( 'If you need support, have a question or suggestion - Leave a message on our support page', 'mega_main_menu' ) . ' <br /> <a href="http://support.megamain.com/?ref=' . $_SERVER["HTTP_HOST"] . $_SERVER["REQUEST_URI"] . '" target="_blank">Support.MegaMain.com</a> ' . __( '(opens in new tab)', 'mega_main_menu' ) . '.<br /> <br />',
						),
						array(
							'name' => __( 'Purchase Code', 'mega_main_menu' ),
							'descr' => __( 'Enter here the purchase code of this product. This action unlocks the automatic updates for you. See where you can find your', 'mega_main_menu' ) . ' <a href="http://support.megamain.com/src/img/megamain-find-item-purchase-code.png" target="_blank">' . __( 'Purchase Code', 'mega_main_menu' ) . '</a>.',
							'key' => 'purchase_code',
							'type' => 'textfield',
							'col_width' => 6,
							'default' => '',
