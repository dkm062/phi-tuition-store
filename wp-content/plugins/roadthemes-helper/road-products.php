...
class RoadProducts {
	...
	public function road_vc_shortcodes() {
		...
		$order_by_values = array(
			...
			__( 'Date', 'junko' )          => 'date',
			__( 'ID', 'junko' )            => 'ID',
			__( 'Author', 'junko' )        => 'author',
			__( 'Title', 'junko' )         => 'title',
			__( 'Modified', 'junko' )      => 'modified',
			__( 'Random', 'junko' )        => 'rand',
			__( 'Comment count', 'junko' ) => 'comment_count',
			__( 'Menu order', 'junko' )    => 'menu_order',
		);

		$order_way_values = array(
			'',
			__( 'Descending', 'junko' ) => 'DESC',
			__( 'Ascending', 'junko' )  => 'ASC',
		); 
		 
	//Sale products Roadthemes
	vc_map( array(
		'name'        => __( 'RT Sale products', 'junko' ),
		'base'        => 'sale_products_r',
		"icon"        => get_template_directory_uri() . "/images/road-icon.jpg",
		'category'    => __( 'Theme', 'junko' ),
		'description' => __( 'List all products on sale', 'junko' ),
		'params'      => array_merge(
			array(
				array(
					'type'        => 'textfield',
					'heading'     => esc_html__( 'Per page', 'junko' ),
					'value'       => 12,
					'save_always' => true,
					'param_name'  => 'per_page',
					'description' => esc_html__( 'How much items per page to show', 'junko' ),
				),
					array(
					'type'        => 'textfield',
					'heading'     => __( 'Columns', 'junko' ),
					'value'       => 4,
					'save_always' => true,
					'param_name'  => 'columns',
					'description' => __( 'How much columns grid', 'junko' ),
				),
				array(
					'type'        => 'dropdown',
					'heading'     => __( 'Order by', 'junko' ),
					'param_name'  => 'orderby',
					'value'       => $order_by_values,
					'save_always' => true,
					'description' => sprintf( __( 'Select how to sort retrieved products. More at %s.', 'junko' ), '<a href="http://codex.wordpress.org/Class_Reference/WP_Query#Order_.26_Orderby_Parameters" target="_blank">WordPress codex page</a>' ),
				),
				array(
					'type'        => 'dropdown',
					'heading'     => __( 'Sort order', 'junko' ),
					'param_name'  => 'order',
					'value'       => $order_way_values,
					'save_always' => true,
					'description' => sprintf( __( 'Designates the ascending or descending order. More at %s.', 'junko' ), '<a href="http://codex.wordpress.org/Class_Reference/WP_Query#Order_.26_Orderby_Parameters" target="_blank">WordPress codex page</a>' ),
				), 
	...
	vc_map( array(
		'name'        => __( 'RT Featured products', 'junko' ),
		'base'        => 'featured_products_r',
		"icon"        => get_template_directory_uri() . "/images/road-icon.jpg",
		'category'    => __( 'Theme', 'junko' ),
		'description' => __( 'Display products set as "featured"', 'junko' ),
		'params'      => array_merge(
		array(
			array(
				'type'        => 'textfield',
	...
	vc_map( array(
	'name'        => __( 'RT Recent products', 'junko' ),
	'base'        => 'recent_products_r',
	"icon"        => get_template_directory_uri() . "/images/road-icon.jpg",
	'category'    => __( 'Theme', 'junko' ),
	'description' => __( 'Lists recent products', 'junko' ),
	'params'      => array_merge( 
		array(
			array(
				'type'        => 'textfield',
	...
	vc_map( array(
	'name' => __( 'Top Rated Products', 'junko' ),
	'base' => 'top_rated_products_r',
	"icon"        => get_template_directory_uri() . "/images/road-icon.jpg",
	'category' => __( 'Theme', 'junko' ),
	'description' => __( 'List all top rated products', 'junko' ),
	'params'      => array_merge( 
		array(
			array(
				'type' => 'textfield',
				'heading' => __( 'Per page', 'junko' ),
				'value' => 12,
				'param_name' => 'per_page',
				'save_always' => true,
				'description' => __( 'How much items per page to show', 'junko' ),
			),
			array(
				'type' => 'textfield',
				'heading' => __( 'Columns', 'junko' ),
	...
	vc_map( array(
	'name'        => __( 'RT Bestselling products', 'junko' ),
	'base'        => 'bestselling_products_r',
	"icon"        => get_template_directory_uri() . "/images/road-icon.jpg",
	'category'    => __( 'Theme', 'junko' ),
	'description' => __( 'List best selling products on sale', 'junko' ),
	'params'      => array_merge( 
		array(
				array(
					'type'        => 'textfield',
	...
	//products Roadthemes
	vc_map( array(
	'name'        => __( 'RT Products', 'junko' ),
	'base'        => 'list_products_r',
	"icon"        => get_template_directory_uri() . "/images/road-icon.jpg",
	'category'    => __( 'Theme', 'junko' ),
	'description' => __( 'Show multiple products by ID or SKU.', 'junko' ),
	'params'      => array_merge(
		array(
			array(
				'type'        => 'textfield',
			...
			array(
				...
				'save_always' => true,
				'description' => __( 'Enter List of Products', 'junko' ),
			),
			array(
				'type'       => 'hidden',
				'param_name' => 'skus',
	...
	vc_map( array(
	'name'        => __( 'RT Product categories', 'junko' ),
	'base'        => 'product_categories_r',
	"icon"        => get_template_directory_uri() . "/images/road-icon.jpg",
	'category'    => __( 'Theme', 'junko' ),
	'description' => __( 'Display product categories loop', 'junko' ),
	'params'      => array_merge( 
			array(
				array(
					'type'        => 'textfield',
					'heading'     => __( 'Number', 'junko' ),
					'param_name'  => 'number',
					'description' => __( 'The `number` field is used to display the number of products.', 'junko' ),
				),
				array(
					'type'        => 'dropdown',
					'heading'     => __( 'Order by', 'junko' ),
				...
				array(
					...
					'description' => __( 'Hide empty', 'junko' ),
				),
				array(
					'type'       => 'autocomplete',
					'heading'    => __( 'Categories', 'junko' ),
					'param_name' => 'ids',
					'settings'   => array(
						'multiple' => true,
						'sortable' => true,
					...
					'save_always' => true,
					'description' => __( 'List of product categories', 'junko' ),
				), 
			),road_get_slider_setting()
		)
	)  );
		...
		vc_map( array(
		'name'        => __( 'RT Product category', 'junko' ),
		'base'        => 'product_category_r',
		"icon"        => get_template_directory_uri() . "/images/road-icon.jpg",
		'category'    => __( 'Theme', 'junko' ),
		'description' => __( 'Show multiple products in a category', 'junko' ),
		'params'      => array_merge(
			array(
				array(
					'type'        => 'textfield',
				...
				array(
					'type'        => 'dropdown',
					'heading'     => __( 'Category', 'junko' ),
					'value'       => $product_categories_dropdown,
					'param_name'  => 'category',
					'save_always' => true,
					'description' => __( 'Product category list', 'junko' ),
				),
			),road_get_slider_setting()
		)
	)  );
		...
		if ( ! empty( $query ) ) {
			...
			if ( is_object( $product_object ) ) {
				...
				if ( ! empty( $product_sku ) ) {
					$product_sku_display = ' - ' . __( 'Sku', 'junko' ) . ': ' . $product_sku;
				}

				$product_title_display = '';
				if ( ! empty( $product_title ) ) {
					$product_title_display = ' - ' . __( 'Title', 'junko' ) . ': ' . $product_title;
				}

				$product_id_display = __( 'Id', 'junko' ) . ': ' . $product_id;
	...
	public function productIdAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				$data = array();
				$data['value'] = $value['id'];
				$data['label'] = __( 'Id', 'junko' ) . ': ' . $value['id'] . ( ( strlen( $value['title'] ) > 0 ) ? ' - ' . __( 'Title', 'junko' ) . ': ' . $value['title'] : '' ) . ( ( strlen( $value['sku'] ) > 0 ) ? ' - ' . __( 'Sku', 'junko' ) . ': ' . $value['sku'] : '' );
				$results[] = $data;
			}
		}
	...
	public function productCategoryCategoryAutocompleteSuggester( $query, $slug = false ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				...
				$data['label'] = __( 'Id', 'junko' ) . ': ' . $value['id'] . ( ( strlen( $value['name'] ) > 0 ) ? ' - ' . __( 'Name', 'junko' ) . ': ' . $value['name'] : '' ) . ( ( strlen( $value['slug'] ) > 0 ) ? ' - ' . __( 'Slug', 'junko' ) . ': ' . $value['slug'] : '' );
				$result[] = $data;
			}
		}
	...
	protected function productCategoryTermOutput( $term ) {
		...
		$term_slug_display = '';
		if ( ! empty( $term_slug ) ) {
			$term_slug_display = ' - ' . __( 'Sku', 'junko' ) . ': ' . $term_slug;
		}

		$term_title_display = '';
		if ( ! empty( $term_title ) ) {
			$term_title_display = ' - ' . __( 'Title', 'junko' ) . ': ' . $term_title;
		}

		$term_id_display = __( 'Id', 'junko' ) . ': ' . $term_id;
	...
	public static function getProductsFieldsList() {
		return array(
			__( 'SKU', 'junko' )               => 'sku',
			__( 'ID', 'junko' )                => 'id',
			__( 'Price', 'junko' )             => 'price',
			__( 'Regular Price', 'junko' )     => 'regular_price',
			__( 'Sale Price', 'junko' )        => 'sale_price',
			__( 'Price html', 'junko' )        => 'price_html',
			__( 'Reviews count', 'junko' )     => 'reviews_count',
			__( 'Short description', 'junko' ) => 'short_description',
			__( 'Dimensions', 'junko' )        => 'dimensions',
			__( 'Rating count', 'junko' )      => 'rating_count',
			__( 'Weight', 'junko' )            => 'weight',
			__( 'Is on sale', 'junko' )        => 'on_sale',
			__( 'Custom field', 'junko' )      => '_custom_',
		);
	}
	...
	public static function getOrderFieldsList() {
		return array(
			__( 'ID', 'junko' )                       => 'id',
			__( 'Order number', 'junko' )             => 'order_number',
			__( 'Currency', 'junko' )                 => 'order_currency',
			__( 'Total', 'junko' )                    => 'total',
			__( 'Status', 'junko' )                   => 'status',
			__( 'Payment method', 'junko' )           => 'payment_method',
			__( 'Billing address city', 'junko' )     => 'billing_address_city',
			__( 'Billing address country', 'junko' )  => 'billing_address_country',
			__( 'Shipping address city', 'junko' )    => 'shipping_address_city',
			__( 'Shipping address country', 'junko' ) => 'shipping_address_country',
			__( 'Customer Note', 'junko' )            => 'customer_note',
			__( 'Customer API', 'junko' )             => 'customer_api',
			__( 'Custom field', 'junko' )             => '_custom_',
		);
	}
